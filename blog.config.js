const BLOG = {
  ...
  link: 'http://rigblog.top',
  newsletter: '',
  description: 'WHERE RIG SAY SOMETHING',
  ...
  socialLink: {
    github: 'https://github.com/owrig',
    telegram: 'https://t.me/RIG_99'
  },
  seo: {
    keywords: ['Notionic', 'RIG', 'Blog'],
    googleSiteVerification: '' // Remove the value or replace it with your own google site verification code
  },
  notionPageId: process.env.NOTION_PAGE_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionSpacesId: process.env.NOTION_SPACES_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionAccessToken: process.env.NOTION_ACCESS_TOKEN, // Useful if you prefer not to make your database public
  notionDomain: 'terrific-tarsal-f15.notion.site',
  telegramToken: process.env.TELEGRAM_TOKEN, // The token of your Telegram bot
  telegramChatId: '6199811140', // The chat id of your Telegram bot
  telegramChannelUrl: 'https://t.me/+ZyUyF6tCk79mOGZh', // The link of your Telegram channel
  telegramChannelName: 'RIGBASE', // The name of your Telegram channel
